...
local CameraShakeInstanceModule = loadstring(readfile("SuperSkid/Scripts/CameraShakeInstance.lua"))()
...
CameraShaker.Presets = loadstring(readfile("SuperSkid/Scripts/CameraShakePresets.lua"))()
